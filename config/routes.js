                    ...
                    subs : [
                        {
                            ...
                            route: "/admin/providers/%d/requests/%d/parameters",
                        ...
                        },
                        {
                            ...
                            route: "/admin/providers/%d/requests/%d/config",
                            parent: "service_requests",
                            icon: "cil-wc",
                            sidebar: false,
                        },
                        {
                            ...
                            route: "/admin/providers/%d/requests/%d/response-keys",
                            parent: "service_requests",
                            icon: "cil-wc",
                            sidebar: false,
                        },
                        {
                            ...
                            label: "Request Test",
                            name: "request_test",
                            route: "/admin/providers/%d/requests/%d/request-test",
                            parent: "service_requests",
                            icon: "cil-wc",
                            sidebar: false,
                        }
